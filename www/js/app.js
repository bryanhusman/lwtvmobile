...
(function() {
    var app = angular.module('sensationApp', ['onsen.directives', 'ngTouch', 'ngSanitize', 'angular-carousel', 'google-maps', 'LocalStorageModule', 'ui.map', 'ui.event']);
    ...
    app.controller('MenuController', function($scope, MenuData) {
        ...
        $scope.showDetail = function(index){
            ...
            $scope.ons.slidingMenu.setMainPage(selectedItem.page);
    ...
    // Plugins Controller
    app.controller('PluginsController', function($scope, $timeout, PluginsData) {
        $timeout(function() {
    ...
    // Product Controller
    app.controller('ProductController', function($scope, $timeout, ProductsData) {
        $timeout(function() {
   ...
   // RSS: Feeds Controller
    ...
    app.controller('MemberController', function($scope, $timeout, AboutData) {
        $timeout(function() {
    ...
    // Seetings Controller
    app.controller('SettingsController', function($scope, $timeout, SettingsData, localStorageService) {
        $timeout(function() {
