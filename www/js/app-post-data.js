...
(function() {
    ...
    app.controller('HomeController', function($scope,$http, Data) {
        ...
        $http({
            method: 'POST', 
            url: 'http://www.gravityforms.com/demo/gravityformsapi/forms/8/entries?api_key=b02768a92c&signature=XuLYD3yt%2F8M87sd15qXZkovueDM%3D&expires= 1404775314',
            data: JSON.stringify([{1.3:"George",1.6:"Tsop",2:"myemail@gmail.com",3:"My second post" }])
        }).
